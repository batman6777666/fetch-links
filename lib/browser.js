...
async function getBrowser() {
    ...
    if (isServerless) {
        try {
            console.log('[Browser] Initializing @sparticuz/chromium for Vercel/Lambda environment…');
            ...
            console.log('[Browser] @sparticuz/chromium successfully launched');
            browserInstance.on('disconnected', () => { browserInstance = null; });
            return browserInstance;
        } catch (err) {
            console.error('[Browser] Failed launching @sparticuz/chromium:', err.message);
        }
    }

    // Local / VPS environment
    try {
        console.log('[Browser] Initializing Playwright Chromium for local environment…');
        ...
        console.error('[Browser] Failed launching local Playwright Chromium:', err.message);
        throw err;
    }
}
